...
export default function Cta() {
  ...
  const stats = [
    { value: '50K+', label: 'Monthly Invoices', icon: DollarSign },
    { value: '3x', label: 'Faster Payments', icon: Clock },
    { value: '15hrs', label: 'Saved Monthly', icon: Sparkles },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join 50,000+ small businesses and freelancers who trust Invoicely for professional
                invoicing. Start your 14-day free trial and get paid 3x faster.
              </p>
